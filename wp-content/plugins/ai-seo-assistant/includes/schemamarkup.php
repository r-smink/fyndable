...
class SchemaMarkup
{
    ...
    public function addMetaBoxes(): void
    {
        ...
        foreach ($postTypes as $postType) {
            add_meta_box(
                'aiseo_schema',
                __('AI SEO Schema Markup', 'ai-seo-assistant'),
                [$this, 'renderMetaBox'],
                $postType,
                'normal',
                'high'
    ...
    public function renderMetaBox(\WP_Post $post): void
    {
        ...
        ?>
        <p>
            <label><strong><?php esc_html_e('Schema Type', 'ai-seo-assistant'); ?></strong></label><br>
            <select name="aiseo_schema_type" style="width:100%;">
                <option value="Article" <?php selected($schemaType, 'Article'); ?>><?php esc_html_e('Article', 'ai-seo-assistant'); ?></option>
                <option value="BlogPosting" <?php selected($schemaType, 'BlogPosting'); ?>><?php esc_html_e('Blog Posting', 'ai-seo-assistant'); ?></option>
                <option value="NewsArticle" <?php selected($schemaType, 'NewsArticle'); ?>><?php esc_html_e('News Article', 'ai-seo-assistant'); ?></option>
                <option value="Product" <?php selected($schemaType, 'Product'); ?>><?php esc_html_e('Product', 'ai-seo-assistant'); ?></option>
                <option value="LocalBusiness" <?php selected($schemaType, 'LocalBusiness'); ?>><?php esc_html_e('Local Business', 'ai-seo-assistant'); ?></option>
                <option value="Organization" <?php selected($schemaType, 'Organization'); ?>><?php esc_html_e('Organization', 'ai-seo-assistant'); ?></option>
                <option value="Person" <?php selected($schemaType, 'Person'); ?>><?php esc_html_e('Person', 'ai-seo-assistant'); ?></option>
                <option value="FAQPage" <?php selected($schemaType, 'FAQPage'); ?>><?php esc_html_e('FAQ Page', 'ai-seo-assistant'); ?></option>
                <option value="HowTo" <?php selected($schemaType, 'HowTo'); ?>><?php esc_html_e('How To', 'ai-seo-assistant'); ?></option>
                <option value="Recipe" <?php selected($schemaType, 'Recipe'); ?>><?php esc_html_e('Recipe', 'ai-seo-assistant'); ?></option>
                <option value="Event" <?php selected($schemaType, 'Event'); ?>><?php esc_html_e('Event', 'ai-seo-assistant'); ?></option>
                <option value="Course" <?php selected($schemaType, 'Course'); ?>><?php esc_html_e('Course', 'ai-seo-assistant'); ?></option>
                <option value="SoftwareApplication" <?php selected($schemaType, 'SoftwareApplication'); ?>><?php esc_html_e('Software Application', 'ai-seo-assistant'); ?></option>
                <option value="Review" <?php selected($schemaType, 'Review'); ?>><?php esc_html_e('Review', 'ai-seo-assistant'); ?></option>
                <option value="AggregateRating" <?php selected($schemaType, 'AggregateRating'); ?>><?php esc_html_e('Aggregate Rating', 'ai-seo-assistant'); ?></option>
                <option value="BreadcrumbList" <?php selected($schemaType, 'BreadcrumbList'); ?>><?php esc_html_e('Breadcrumbs (auto)', 'ai-seo-assistant'); ?></option>
                <option value="WebSite" <?php selected($schemaType, 'WebSite'); ?>><?php esc_html_e('WebSite (SearchAction)', 'ai-seo-assistant'); ?></option>
            </select>
        </p>
        <p>
            <label><strong><?php esc_html_e('Custom JSON-LD (optional)', 'ai-seo-assistant'); ?></strong></label><br>
            ...
            <small><?php esc_html_e('Override with custom JSON-LD schema', 'ai-seo-assistant'); ?></small>
        </p>
        <?php
    }
    ...
    {
        $crumbs = [['title' => __('Home', 'ai-seo-assistant'), 'url' => home_url('/')]];
        ...
        if (is_singular()) {
            ...
            $crumbs[] = [
                'title' => sprintf(__('Search: %s', 'ai-seo-assistant'), get_search_query()),
                'url' => get_search_link(),
            ];
        }
