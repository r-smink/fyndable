...
class LocalSEO
{
    ...
    public function renderMetaBox(\WP_Post $post): void
    {
        ...
        <p>
            <label>
                ...
                <?php esc_html_e('This is a location/branch page', 'ai-seo-assistant'); ?>
            </label>
        </p>
        <p>
            <label><?php esc_html_e('Location Name', 'ai-seo-assistant'); ?></label>
            <input type="text" name="aiseo_location_name" value="<?php echo esc_attr($locationName); ?>" class="regular-text">
        </p>
        <p>
            <label><?php esc_html_e('Full Address', 'ai-seo-assistant'); ?></label>
    ...
    public function renderSettings(): void
    {
        $options = $this->settings->all();
        ?>
        <h3><?php esc_html_e('Local SEO Settings', 'ai-seo-assistant'); ?></h3>
        <table class="form-table">
            <tr>
                <th><?php esc_html_e('Business Name', 'ai-seo-assistant'); ?></th>
            ...
            <tr>
                <th><?php esc_html_e('Business Type', 'ai-seo-assistant'); ?></th>
                <td>
                    <select name="aiseoassistant[local_business_type]">
                        <option value="LocalBusiness"><?php esc_html_e('Local Business', 'ai-seo-assistant'); ?></option>
                        <option value="Restaurant"><?php esc_html_e('Restaurant', 'ai-seo-assistant'); ?></option>
                        <option value="Store"><?php esc_html_e('Store', 'ai-seo-assistant'); ?></option>
                        <option value="Dentist"><?php esc_html_e('Dentist', 'ai-seo-assistant'); ?></option>
                        <option value="Doctor"><?php esc_html_e('Doctor', 'ai-seo-assistant'); ?></option>
                        <option value="Plumber"><?php esc_html_e('Plumber', 'ai-seo-assistant'); ?></option>
                        <option value="Electrician"><?php esc_html_e('Electrician', 'ai-seo-assistant'); ?></option>
                        <option value="Lawyer"><?php esc_html_e('Lawyer', 'ai-seo-assistant'); ?></option>
                        <option value="RealEstateAgent"><?php esc_html_e('Real Estate Agent', 'ai-seo-assistant'); ?></option>
                        <option value="HairSalon"><?php esc_html_e('Hair Salon', 'ai-seo-assistant'); ?></option>
                        <option value="AutoRepair"><?php esc_html_e('Auto Repair', 'ai-seo-assistant'); ?></option>
                    </select>
                </td>
            </tr>
            <tr>
                <th><?php esc_html_e('Description', 'ai-seo-assistant'); ?></th>
            ...
            <tr>
                <th><?php esc_html_e('Address', 'ai-seo-assistant'); ?></th>
                <td>
            ...
            <tr>
                <th><?php esc_html_e('Coordinates', 'ai-seo-assistant'); ?></th>
                <td>
            ...
            <tr>
                <th><?php esc_html_e('Contact', 'ai-seo-assistant'); ?></th>
                <td>
            ...
            <tr>
                <th><?php esc_html_e('Opening Hours', 'ai-seo-assistant'); ?></th>
                <td>
                    ...
                    <p class="description"><?php esc_html_e('One per line. Format: Mo-Fr 09:00-17:00', 'ai-seo-assistant'); ?></p>
                </td>
            </tr>
            <tr>
                <th><?php esc_html_e('Business Image', 'ai-seo-assistant'); ?></th>
                <td><input type="url" name="aiseoassistant[local_image]" value="<?php echo esc_attr($options['local_image'] ?? ''); ?>" class="regular-text"></td>
            </tr>
            <tr>
                <th><?php esc_html_e('Price Range', 'ai-seo-assistant'); ?></th>
                <td>
