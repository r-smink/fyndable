...
class RobotsTxt
{
    ...
    public function renderSettings(): void
    {
        ...
        $custom = $this->settings->get('robots_txt_content', '');
        ?>
        <h3><?php esc_html_e('Robots.txt Editor', 'ai-seo-assistant'); ?></h3>
        <p><?php esc_html_e('Configure how search engines crawl your site.', 'ai-seo-assistant'); ?></p>

        <h4><?php esc_html_e('Custom robots.txt', 'ai-seo-assistant'); ?></h4>
        <p>
            ...
            <small><?php esc_html_e('Leave empty to use generated rules below', 'ai-seo-assistant'); ?></small>
        </p>

        <h4><?php esc_html_e('Rules Generator', 'ai-seo-assistant'); ?></h4>
        <div id="robots-rules">
            <?php foreach ($rules as $i => $rule) : ?>
            <div class="robot-rule" style="border:1px solid #ccc; padding:10px; margin:10px 0;">
                <p>
                    <label><?php esc_html_e('User-agent', 'ai-seo-assistant'); ?></label>
                ...
                <p>
                    <label><?php esc_html_e('Allow paths (one per line)', 'ai-seo-assistant'); ?></label>
                ...
                <p>
                    <label><?php esc_html_e('Disallow paths (one per line)', 'ai-seo-assistant'); ?></label>
                ...
                <p>
                    <label><?php esc_html_e('Crawl-delay (seconds)', 'ai-seo-assistant'); ?></label>
        ...
        <p>
            <button type="button" class="button" id="add-robot-rule"><?php esc_html_e('+ Add Rule', 'ai-seo-assistant'); ?></button>
        </p>

        <h4><?php esc_html_e('Preview', 'ai-seo-assistant'); ?></h4>
