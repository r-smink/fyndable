		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			<head>
				...
				<style type="text/css">
					...
					#description a {
						color: #379fd3;
						border-bottom: 1px dotted rgba(55,159,211,0.5);
					}
					#description a:hover {
			...
			<body>
				...
				<div id="description">
					...
					<h1>XML Sitemap</h1>
					<p>
						This XML sitemap is generated by <span style="color:#379fd3; border-bottom:1px dotted rgba(55,159,211,0.5);">Fyndable</span>.
				...
				<div class="footer">
					Generated by <span style="color:#379fd3;">Fyndable</span>
				</div>
