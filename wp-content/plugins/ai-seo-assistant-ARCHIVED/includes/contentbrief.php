...
class ContentBrief
{
    ...
    public function addMenu(): void
    {
        add_submenu_page(
            'ai-seo-assistant',
            __('Content Brief', 'ai-seo-assistant'),
            __('Content Brief', 'ai-seo-assistant'),
            'manage_options',
...
PROMPT;
    ...
    private function estimateKeywordDifficulty(array $results): array
    {
        ...
        return [
            ...
            'description' => match ($level) {
                'hard' => __('High competition. Many authoritative domains ranking. Requires strong content and backlinks.', 'ai-seo-assistant'),
                'medium' => __('Moderate competition. Mix of authoritative and niche sites. Winnable with quality content.', 'ai-seo-assistant'),
                'easy' => __('Low competition. Few major brands ranking. Good opportunity for quick wins.', 'ai-seo-assistant'),
            },
        ];
    }
    ...
    public function restGenerateBrief(\WP_REST_Request $request): array|\WP_Error
    {
        ...
        if (!$keyword) {
            return new \WP_Error('no_keyword', __('Keyword is required', 'ai-seo-assistant'));
        }
    ...
    public function restScoreContent(\WP_REST_Request $request): array|\WP_Error
    {
        ...
        if (!$keyword || !$content) {
            return new \WP_Error('missing_params', __('Keyword and content are required', 'ai-seo-assistant'));
        }
    ...
    public function renderPage(): void
    {
        ...
        <div class="wrap aiseo-modern">
            <h1><?php esc_html_e('Content Brief Generator', 'ai-seo-assistant'); ?></h1>
            <p class="description"><?php esc_html_e('Generate data-driven content briefs by analyzing top-ranking pages. Like Surfer SEO, but built into WordPress.', 'ai-seo-assistant'); ?></p>

            <div class="aiseo-brief-generator" style="max-width: 1200px;">
                <div class="postbox" style="padding: 20px;">
                    <h2><?php esc_html_e('Generate New Brief', 'ai-seo-assistant'); ?></h2>
                    <p>
                        <input type="text" id="aiseo-brief-keyword" class="regular-text" style="width: 400px;" placeholder="<?php esc_attr_e('Enter target keyword...', 'ai-seo-assistant'); ?>">
                        <button type="button" class="button button-primary" id="aiseo-generate-brief">
                            <?php esc_html_e('Generate Brief', 'ai-seo-assistant'); ?>
                        </button>
                ...
                <div id="aiseo-brief-result" style="display:none; margin-top: 20px;">
                    ...
                    <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; margin-bottom: 20px;">
                        <div class="postbox" style="padding: 15px; text-align: center;">
                            ...
                            <div><?php esc_html_e('Difficulty', 'ai-seo-assistant'); ?></div>
                        </div>
                        <div class="postbox" style="padding: 15px; text-align: center;">
                            <div id="brief-word-count" style="font-size: 28px; font-weight: bold;">-</div>
                            <div><?php esc_html_e('Target Words', 'ai-seo-assistant'); ?></div>
                        </div>
                        <div class="postbox" style="padding: 15px; text-align: center;">
                            <div id="brief-intent" style="font-size: 28px; font-weight: bold;">-</div>
                            <div><?php esc_html_e('Search Intent', 'ai-seo-assistant'); ?></div>
                        </div>
                        <div class="postbox" style="padding: 15px; text-align: center;">
                            <div id="brief-headings-count" style="font-size: 28px; font-weight: bold;">-</div>
                            <div><?php esc_html_e('Recommended Headings', 'ai-seo-assistant'); ?></div>
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        ...
                        <div>
                            <div class="postbox" style="padding: 15px;">
                                <h3><?php esc_html_e('Content Outline', 'ai-seo-assistant'); ?></h3>
                            ...
                            <div class="postbox" style="padding: 15px; margin-top: 15px;">
                                <h3><?php esc_html_e('Recommended Headings', 'ai-seo-assistant'); ?></h3>
                                <ul id="brief-headings" style="list-style: none; padding: 0;"></ul>
                            </div>

                            <div class="postbox" style="padding: 15px; margin-top: 15px;">
                                <h3><?php esc_html_e('Questions to Answer (FAQ)', 'ai-seo-assistant'); ?></h3>
                        ...
                        <div>
                            <div class="postbox" style="padding: 15px;">
                                <h3><?php esc_html_e('SERP Overview', 'ai-seo-assistant'); ?></h3>
                                <table class="wp-list-table widefat fixed striped" style="font-size: 12px;">
                                    <thead>
                                        <tr>
                                            <th style="width:30px;">#</th>
                                            <th><?php esc_html_e('Title', 'ai-seo-assistant'); ?></th>
                                        </tr>
                                    </thead>
                            ...
                            <div class="postbox" style="padding: 15px; margin-top: 15px;">
                                <h3><?php esc_html_e('Entities & Topics to Cover', 'ai-seo-assistant'); ?></h3>
                                <div id="brief-entities" style="display: flex; flex-wrap: wrap; gap: 5px;"></div>
                            </div>

                            <div class="postbox" style="padding: 15px; margin-top: 15px;">
                                <h3><?php esc_html_e('LSI / Semantic Keywords', 'ai-seo-assistant'); ?></h3>
                                <div id="brief-lsi" style="display: flex; flex-wrap: wrap; gap: 5px;"></div>
                            </div>

                            <div class="postbox" style="padding: 15px; margin-top: 15px;">
                                <h3><?php esc_html_e('Internal Link Opportunities', 'ai-seo-assistant'); ?></h3>
                    ...
                    <div class="postbox" style="padding: 15px; margin-top: 20px;">
                        <h3><?php esc_html_e('Content Scoring', 'ai-seo-assistant'); ?></h3>
                        <p class="description"><?php esc_html_e('Paste your content below to score it against this brief\'s recommendations.', 'ai-seo-assistant'); ?></p>
                        <textarea id="aiseo-score-content" rows="8" class="large-text" placeholder="<?php esc_attr_e('Paste your article content here to get a score...', 'ai-seo-assistant'); ?>"></textarea>
                        <p>
                            <button type="button" class="button button-primary" id="aiseo-score-btn"><?php esc_html_e('Score Content', 'ai-seo-assistant'); ?></button>
                        </p>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#aiseo-generate-brief').on('click', function() {
                ...
                if (!keyword) return alert('<?php echo esc_js(__('Enter a keyword', 'ai-seo-assistant')); ?>');
            ...
            function renderBrief(brief) {
                ...
                $('#brief-internal-links').html(linksHtml || '<li><?php echo esc_js(__('No matching internal pages found.', 'ai-seo-assistant')); ?></li>');
            }
            ...
            $('#aiseo-score-btn').on('click', function() {
                ...
                var btn = $(this);
                btn.prop('disabled', true).text('<?php echo esc_js(__('Scoring...', 'ai-seo-assistant')); ?>');
                ...
                wp.apiFetch({
                    ...
                    renderScore(result);
                    btn.prop('disabled', false).text('<?php echo esc_js(__('Score Content', 'ai-seo-assistant')); ?>');
                }).catch(function(err) {
            ...
            function renderScore(result) {
                ...
                var labels = {
                    word_count: '<?php echo esc_js(__('Word Count', 'ai-seo-assistant')); ?>',
                    keyword_usage: '<?php echo esc_js(__('Keyword Usage', 'ai-seo-assistant')); ?>',
                    heading_coverage: '<?php echo esc_js(__('Heading Coverage', 'ai-seo-assistant')); ?>',
                    entity_coverage: '<?php echo esc_js(__('Entity Coverage', 'ai-seo-assistant')); ?>',
                    lsi_coverage: '<?php echo esc_js(__('LSI Keywords', 'ai-seo-assistant')); ?>',
                    question_coverage: '<?php echo esc_js(__('FAQ Coverage', 'ai-seo-assistant')); ?>'
                };
