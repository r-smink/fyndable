...
class SmartTags
{
    ...
    public function addMetaBox(): void
    {
        add_meta_box(
            'aiseo_smart_tags',
            __('AI Smart Tags', 'ai-seo-assistant'),
            [$this, 'renderMetaBox'],
            'post',
            'side',
            'default'
    ...
    public function renderMetaBox(\WP_Post $post): void
    {
        ...
        <div class="aiseo-smart-tags-box">
            <p><?php esc_html_e('AI-suggested tags based on your content:', 'ai-seo-assistant'); ?></p>
            
            <button type="button" class="button" id="aiseo-generate-tags" data-post="<?php echo $post->ID; ?>">
                <?php esc_html_e('Generate Smart Tags', 'ai-seo-assistant'); ?>
            </button>
            
            <div id="aiseo-tags-suggestions" style="margin-top:15px;">
                <?php if ($suggested) : ?>
                <p><strong><?php esc_html_e('Suggested:', 'ai-seo-assistant'); ?></strong></p>
                ...
                <?php else : ?>
                <p class="description"><em><?php esc_html_e('Click "Generate Smart Tags" to analyze your content and suggest relevant tags.', 'ai-seo-assistant'); ?></em></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        jQuery(document).ready(function($) {
            $('#aiseo-generate-tags').on('click', function() {
                ...
                wp.apiFetch({
                    ...
                    var html = '<p><strong><?php echo esc_js(__('Suggested:', 'ai-seo-assistant')); ?></strong></p>';
                    ...
                    btn.prop('disabled', false).text('<?php esc_html_e('Generate Smart Tags', 'ai-seo-assistant'); ?>');
                });
            });
